...
HurricaneAgent = Agent(
    name="HurricaneAgent",
    port=8004,
    seed="Hurricane agent secret phrase",
    endpoint=["http://127.0.0.1:8004/submit"],
)
  
print("Hurricane agent", HurricaneAgent.address)

history = []
task = ''

@HurricaneAgent.on_message(model=Message)
...
For example, if you are trying to predict hurricane risk in a certain area, you might start by querying the manager for current ocean temperatures, wind patterns, or historical hurricane data in that region.
