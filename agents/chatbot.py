...
EXS = [
    ...
    {
        "EarthquakeAgent (agent1qf972ckn3x7lkt324ycz8ehryg7gcwtqf25dfl423fkjpvj43hp2c8mq8ft)": """Data shows that LA has a high earthquake risk, with a magnitude 7.8 event expected within the next 30 years. Risk factor: 9.15. Expected property loss at (34.0522° N, 118.2437° W): $35,000
        """
    },
    {
        "ManagerAgent (agent1qfn5swgk6w03f0junfx3r6239ulk0rz7pl08cya7cx7tzf794cl8urqsmdk)": """Conclusion: According to the data provided by the various agents, Los Angeles presents significant risks across multiple natural disaster categories.
